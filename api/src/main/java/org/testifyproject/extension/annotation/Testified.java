...
public @interface Testified {
    ...
    /**
     * The value element MUST have the name of the code generator. The recommended convention is
     * to use the fully qualified name of the code generator (i.e. com.acme.generator.CodeGen).
     *
