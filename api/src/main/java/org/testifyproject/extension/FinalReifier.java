...
/**
 * A contract that defines a method to perform final reification of the test class. Note test class
 * reification is executed in the following order:
 * <ul>
