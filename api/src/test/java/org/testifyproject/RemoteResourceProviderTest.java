 ...
 * @author saden
 */
public class RemoteResourceProviderTest {

    RemoteResourceProvider sut;

    @Before
    public void init() {
        sut = mock(RemoteResourceProvider.class, Answers.CALLS_REAL_METHODS);
    }

    @Test
    public void callToStopShouldDoNothing() throws Exception {
        TestContext testContext = mock(TestContext.class);
        RemoteResource resource = mock(RemoteResource.class);
        RemoteResourceInstance instance = mock(RemoteResourceInstance.class);
