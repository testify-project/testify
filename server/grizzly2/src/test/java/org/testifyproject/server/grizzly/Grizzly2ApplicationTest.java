...
import org.testifyproject.server.fixture.ApplicationTester;
import org.testifyproject.server.fixture.TestApplication;

/**
 *
 * @author saden
 */
public class Grizzly2ApplicationTest {

    @Test
    public void verifyInterception() throws Exception {
        Class<ApplicationTester> testClass = ApplicationTester.class;
