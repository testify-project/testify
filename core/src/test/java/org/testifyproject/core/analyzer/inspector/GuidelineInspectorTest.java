 ...
 * @author saden
 */
public class GuidelineInspectorTest {

    GuidelineInspector sut;

    @Before
    public void init() {
        sut = new GuidelineInspector();
    }
    ...
    public void givenParamtersInspectShouldAddProperty() {
        ...
        Strict annotation = mock(Strict.class);
        Class type = Strict.class;

        given(annotation.annotationType()).willReturn(type);
