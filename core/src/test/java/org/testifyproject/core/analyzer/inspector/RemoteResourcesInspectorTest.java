 ...
 * @author saden
 */
public class RemoteResourcesInspectorTest {

    RemoteResourcesInspector sut;

    @Before
    public void init() {
        sut = new RemoteResourcesInspector();
    }
    ...
    public void givenParamtersInspectShouldAddProperty() {
        ...
        RemoteResources annotation = mock(RemoteResources.class);
        RemoteResource element = mock(RemoteResource.class);

        given(annotation.value()).willReturn(new RemoteResource[]{element});
