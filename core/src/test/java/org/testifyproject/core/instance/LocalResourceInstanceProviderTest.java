...
public class LocalResourceInstanceProviderTest {
    ...
    public void givenTestContextWithLocalResourceInstancesWithoutNameGetShouldReturnInstnaces() {
        ...
        LocalResourceInfo resourceInstance = mock(LocalResourceInfo.class);
        List<LocalResourceInfo> localResourcesInstances = ImmutableList.of(
                resourceInstance);
        ...
        given(testContext.getLocalResources()).willReturn(localResourcesInstances);
