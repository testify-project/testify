 ...
 * @author saden
 */
public class AgentConstructorGreeterInterceptor {

    @RuntimeType
    @BindingPriority(Integer.MAX_VALUE)
    public void anyConstructor(@This Object greeter,
            @Argument(0) String phrase)
            throws Exception {
        Field field = greeter.getClass().getDeclaredField("phrase");
        field.setAccessible(true);
        field.set(greeter, phrase.toUpperCase());
