 ...
 */
@Discoverable
public class AgentConstructorGreeterInstrumentProvider implements InstrumentProvider {

    @Override
    public InstrumentInstance get() {
        return InstrumentInstanceBuilder.builder()
                .constructor()
                .build("org.testifyproject.fixture.instrument.AgentConstructorGreeter",
                        new AgentConstructorGreeterInterceptor());
    }
