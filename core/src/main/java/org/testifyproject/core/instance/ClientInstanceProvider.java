...
@SystemCategory
@Discoverable
public class ClientInstanceProvider implements PostInstanceProvider {
    ...
    public List<Instance> get(TestContext testContext) {
        ...
        foundClientInstance.ifPresent(clientInstance -> {
            ...
            builder.add(clientInstance.getClient());
            clientInstance.getClientProvider().ifPresent(builder::add);
        });
