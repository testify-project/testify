 ...
 * @author saden
 */
public class HK2AbstractBinder extends AbstractBinder {

    private final Queue<Instance<?>> constants;

    HK2AbstractBinder(Queue<Instance<?>> constants) {
        this.constants = constants;
    }

    /**
     * Create an instance of HK2AbstractBinder using the given queue of constants.
     *
     * @param constants the constants
     * @return a module instance
     */
    public static final Binder of(Queue<Instance<?>> constants) {
        return new HK2AbstractBinder(constants);
    }
