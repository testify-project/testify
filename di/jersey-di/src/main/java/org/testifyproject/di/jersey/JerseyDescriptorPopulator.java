 ...
 * @author saden
 */
public class JerseyDescriptorPopulator implements DescriptorFileFinder {

    private final ClassLoader classLoader;
    private final String[] resources;

    public JerseyDescriptorPopulator(String... resources) {
        this(Thread.currentThread().getContextClassLoader(), resources);
    }

    public JerseyDescriptorPopulator(ClassLoader classLoader, String... resources) {
