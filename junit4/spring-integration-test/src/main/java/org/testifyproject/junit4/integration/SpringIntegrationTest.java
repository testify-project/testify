...
/**
 * A JUnit Spring integration test class runner. This class is the main entry point for running
 * Spring integration test using {@link org.junit.runner.RunWith}. It provides means of creating
 * your system under test, faking certain collaborators or using real collaborators in the
