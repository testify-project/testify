 ...
 * Netty Server Provider operations.
 *
 * @author saden
 */
@Discoverable
public class NettyServerProviderInstrumentProvider implements InstrumentProvider {

    @Override
    public InstrumentInstance get() {
        return InstrumentInstanceBuilder.builder()
                .build("io.grpc.netty.NettyServerProvider", new NettyServerProviderInterceptor());
    }
