...
@SystemTest
public class RealResolverSystemTest {
    ...
    @Test
    public void verifyCreatedRealParameter(@Real TestClass testClass) {
        assertThat(testClass).isNotNull();
        assertThat(Mockito.mockingDetails(testClass).isMock()).isFalse();
    }
    
    @Test
    public void verifyDiscoveredRealParameter(@Real TestContext testContext) {
