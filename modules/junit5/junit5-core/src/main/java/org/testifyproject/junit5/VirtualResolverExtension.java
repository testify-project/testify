...
public class VirtualResolverExtension implements ParameterResolver {
    ...
    public boolean supportsParameter(ParameterContext pc, ExtensionContext ec)
        ...
        return pc.getParameter().getAnnotation(Virtual.class) != null;
    }
    ...
    public Object resolveParameter(ParameterContext pc, ExtensionContext ec)
        ...
        Object realInstance = ReflectionUtil.INSTANCE.newInstance(paramType);

        return mockProvider.createVirtual(paramType, realInstance);
    }
