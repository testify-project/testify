 ...
 * @author saden
 */
public class JerseyInjectionResolverTest {

    JerseyInjectionResolver sut;
    ...
    public void init() {
        ...
        sut = new JerseyInjectionResolver(testContext, injectionManager);
    }
    ...
    public void givenTestContextWithoutSutDescriptorResolveShouldCallThreeThirtyResolver() {
        ...
        given(injectionManager.getInstance(
                eq(InjectionResolver.class),
                eq(new NamedImpl(SYSTEM_RESOLVER_NAME)))
        ...
        verify(injectionManager).getInstance(
                eq(InjectionResolver.class),
                eq(new NamedImpl(SYSTEM_RESOLVER_NAME))
        );
        verify(threeThirtyResolver).resolve(injectee, root);
        verifyNoMoreInteractions(testContext, injectionManager, threeThirtyResolver);
    }
