 ...
 * @author saden
 */
public class DefaultRemoteResourceInfoTest {

    ResourceInfo sut;

    RemoteResource annotation;
    RemoteResourceProvider provider;
    RemoteResourceInstance value;

    @Before
    public void init() {
        annotation = mock(RemoteResource.class);
        provider = mock(RemoteResourceProvider.class);
        value = mock(RemoteResourceInstance.class);

        sut = DefaultRemoteResourceInfo.of(annotation, provider, value);
    }
    ...
    public void givenUnequalInstancesShouldNotBeEqual() {
        ResourceInfo unequal = DefaultRemoteResourceInfo.of(annotation, provider, null);
    ...
    public void givenEqualInstancesShouldBeEqual() {
        ResourceInfo equal = DefaultRemoteResourceInfo.of(annotation, provider, value);
    ...
    public void callToToStringShouldReturnHumanReadableString() {
        ...
        assertThat(result)
                .contains("DefaultRemoteResourceInfo", "annotation", "provider", "value");
    }
