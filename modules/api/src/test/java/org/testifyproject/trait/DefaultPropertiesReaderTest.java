 ...
 * @author saden
 */
public class DefaultPropertiesReaderTest {
    ...
    public void init() {
        ...
        sut = DefaultPropertiesReader.of(properties);
    }
    ...
    public void givenUnequalInstancesShouldNotBeEqual() {
        PropertiesReader unequal = DefaultPropertiesReader.of(ImmutableMap.of());
    ...
    public void givenEqualInstancesShouldBeEqual() {
        PropertiesReader equal = DefaultPropertiesReader.of(properties);
    ...
    public void callToToStringShouldReturnHumanReadableString() {
        ...
        assertThat(result).contains("DefaultPropertiesReader", "properties");
    }
